...
if __name__ == "__main__":
    ...
    print("Qwen3 4B Finetuned LR=5e-5 + WSD 0.25:", get_success_failure(df8))
    print("Qwen3 4B Finetuned LR=7e-5:", get_success_failure(df6))
    print("Qwen3 4B Finetuned LR=7e-5 + WSD:", get_success_failure(df7))
    ...
    print("Qwen3 4B Finetuned LR=5e-5 + WSD 0.25 Average turn count for successful attempts:", get_average_turn_count(df8))
    print("Qwen3 4B Finetuned LR=7e-5 Average turn count for successful attempts:", get_average_turn_count(df6))
    print("Qwen3 4B Finetuned LR=7e-5 + WSD Average turn count for successful attempts:", get_average_turn_count(df7))
    ...
    print("Qwen3 4B Finetuned LR=5e-5 + WSD 0.25 Average retries for successful attempts:", get_average_retries(df8))
    print("Qwen3 4B Finetuned LR=7e-5 Average retries for successful attempts:", get_average_retries(df6))
    print("Qwen3 4B Finetuned LR=7e-5 + WSD Average retries for successful attempts:", get_average_retries(df7))